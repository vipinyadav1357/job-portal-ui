...
const renderlinks = (location: any) => {
    return (links.map((link, index) =>
        <div key={index} className={`${location.pathname === "/" + link.url ? "border-b-[3px] border-bright-sun-400 text-bright-sun-400 h-fit flex items-center [text-shadow:_0px_0px_3px_#f99b07,_-0px_-0px_3px_#f99b07,_-0px_0px_3px_#f99b07,_0px_-0px_3px_#f99b07]" : "hover:border-b-[3px] hover:border-bright-sun-400 hover:text-bright-sun-400 hover:h-fit hover:flex hover:items-center"}`}>
