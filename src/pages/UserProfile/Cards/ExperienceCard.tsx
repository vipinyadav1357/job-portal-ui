            ...
            <div className='bg-mine-shaft-900  p-4 rounded-xl flex flex-col gap-5' >
                ...
                <div className='text-mine-shaft-300 text-sm text-justify p-1'>{props.description}</div>
                {
                    ...
                    <div className='flex justify-start gap-10 items-center'>
                        ...
                        <Button variant='subtle' color='red' className='bg-mine-shaft-950 hover:bg-bright-sun-400/20 transition duration-300 ease-in-out' >Delete</Button>
                    </div>
                }
            </div > : <ExpInput setEditexp={setEditexp} />
