...
const JobCard = (props: any) => {
    return (
        <div className='cursor-pointer bg-mine-shaft-900 w-72 p-4 rounded-xl flex flex-col gap-3 hover:shadow-[0_0_15px_5px_rgba(255,223,0,0.5)] !hover:shadow-bright-sun-400 transition-all duration-500 ease-in-out'>
            <div className='flex justify-between'>
                <div className='flex items-center gap-2'>
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <div className='text-xs text-mine-shaft-300'>{props.company} <IconPointFilled width={16} height={16} className='inline-block' /> {props.applicants} applicants</div>
                    </div>
                </div>
                <IconBookmark className='text-mine-shaft-300' />
            </div>
            ...
            <div className='flex justify-between text-xs text-mine-shaft-400 items-center'>
                ...
                <div className='flex items-center gap-1'><IconClockHour3 className='inline-block' />{props.postedDaysAgo} Days ago</div>
            </div>
        </div>
    )
}
